...
use crate::ui::grid::{GlobalInfiniteGridSettings, GridFrustumIntersect};
...
impl<const I: usize, P: PhaseItem> RenderCommand<P> for SetGridShadowBindGroup<I> {
    ...
    fn render<'w>(
        ...
        bg_offset: ROQueryItem<'w, Self::ItemQuery>,
...
pub struct GridShadowPassLabel;
...
pub fn register_shadow(app: &mut App) {
    ...
    draw_3d_graph.add_node_edge(GridShadowPassLabel, Labels3d::EndMainPass);
}
